...
# Load models
model_seg = YOLO(r"/home/minh/Desktop/Hack-HCMC-Solution/MVP/Flask-Server-template/ai/weights/v8m_drinking_area_segmentation/best.pt")
model_detec_beer = YOLO(r"/home/minh/Desktop/Hack-HCMC-Solution/MVP/Flask-Server-template/ai/weights/v8m_beer_detection/best.pt")
model_detec_human = YOLO(r"/home/minh/Desktop/Hack-HCMC-Solution/MVP/Flask-Server-template/ai/weights/v8m_human_detection/best.pt")
...
def get_response(img_path):
    ...
    # Detect beers
    results_detec_beer = model_detec_beer(mask_img, device='cuda')
